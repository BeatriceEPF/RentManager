                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <h3 class="profile-username text-center">${client.firstName} ${client.name} (${client.email})</h3>
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${reservations}" var="reservation">
                                            ...
                                            <td>${reservation.vehicule.nb_places}</td>
                            ...
                            <div class="tab-pane" id="cars">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                        <c:forEach items="${vehicles}" var="vehicule">
                                            <td>${vehicule.id}</td>
